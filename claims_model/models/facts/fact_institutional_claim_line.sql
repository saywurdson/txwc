-- fact_institutional_claim_detail.sql
with base as (
    select
        fb.bill_id,
        det.bill_detail_id,
        ...
        det.revenue_billed_code,
        det.revenue_unit_rate,
    ...
    from {{ ref('stg_institutional_detail') }} det
    left join {{ ref('fact_institutional_claim') }} fb
