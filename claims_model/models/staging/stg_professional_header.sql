{% set exists_current = check_table_exists('raw', 'professional_header_current') %}
{% set exists_historical = check_table_exists('raw', 'professional_header_historical') %}
