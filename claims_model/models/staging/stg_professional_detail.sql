{% set exists_current = check_table_exists('raw', 'professional_detail_current') %}
{% set exists_historical = check_table_exists('raw', 'professional_detail_historical') %}
...
professional_detail_current as (
    select
        ...
        first_diagnosis_pointer,
        second_diagnosis_pointer,
        third_diagnosis_pointer,
        fourth_diagnosis_pointer,
        crna_supervision_indicator,
