select 
    ...
    cast(observation_type_concept_id as varchar) as observation_type_concept_id,
    ...
    cast(qualifier_concept_id as varchar) as qualifier_concept_id,
    ...
    ) }} as varchar) as observation_source_concept_id,
