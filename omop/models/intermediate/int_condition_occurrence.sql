select
    ...
    cast(condition_type_concept_id as varchar) as condition_type_concept_id,
    cast(condition_status_concept_id as varchar) as condition_status_concept_id,
    ...
    ) }} as varchar) as condition_source_concept_id,
