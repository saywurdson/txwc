...
unpivot_ihc_diagnoses as (
    -- Unpivot the diagnoses and prioritize in order to assign the correct observation_status_concept_id.
    select 
        ihc.bill_id,
...
final_ihh as (
    select 
        ...
        cast(null as integer) as observation_concept_id,
        cast(ihh.service_bill_from_date as date) as observation_date,
        cast(ihh.service_bill_from_date as timestamp) as observation_datetime,
        32855 as observation_type_concept_id,
        cast(null as float) as value_as_number,
        cast(null as varchar) as value_as_string,
        cast(null as integer) as value_as_concept_id,
...
final_phh as (
    select 
        ...
        cast(null as integer) as observation_concept_id,
        cast(phh.service_bill_from_date as date) as observation_date,
        cast(phh.service_bill_from_date as timestamp) as observation_datetime,
        32855 as observation_type_concept_id,
        cast(null as float) as value_as_number,
        cast(null as varchar) as value_as_string,
        cast(null as integer) as value_as_concept_id,
...
institutional_detail_historical as (
    select 
        ...
        cast(null as integer) as observation_concept_id,
        cast(idh.service_line_from_date as date) as observation_date,
        cast(idh.service_line_from_date as timestamp) as observation_datetime,
        32854 as observation_type_concept_id,
        cast(null as float) as value_as_number,
        cast(null as varchar) as value_as_string,
        cast(null as integer) as value_as_concept_id,
...
professional_detail_historical as (
    select 
        ...
        cast(null as integer) as observation_concept_id,
        cast(prdh.service_line_from_date as date) as observation_date,
        cast(prdh.service_line_from_date as timestamp) as observation_datetime,
        32854 as observation_type_concept_id,
        cast(null as float) as value_as_number,
        cast(null as varchar) as value_as_string,
        cast(null as integer) as value_as_concept_id,
